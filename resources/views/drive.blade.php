...
<div class="row white-section no-margin">
    <div class="container">
        ...
        <div class="col-md-4 content-block small">
            ...
            <p>You can drive with {{ Setting::get('site_title', 'Xeride') }} anytime, day or night, 365 days a year. When you drive is always up to you, so it never interferes with the important things in your life.</p>
        </div>
...
<div class="row white-section no-margin">
    <div class="container">
        ...
        <div class="col-md-4 content-block small">
            <h2>Safety</h2>
            <div class="title-divider"></div>
            <p>When you drive with {{ Setting::get('site_title', 'Xeride') }}, you get 24/7 driver support and insurance coverage. And all riders are verified with their personal information and phone number, so you’ll know who you’re picking up and so will we.</p>
        </div>
