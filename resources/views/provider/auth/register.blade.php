...
<div class="col-md-12">
    <form class="form-horizontal" role="form" method="POST" action="{{ url('/provider/register') }}">
        ...
        <div id="first_step">
            <div class="col-md-4">
                <input value="+27" type="text" placeholder="+27" id="country_code" name="country_code" />
            </div> 
...
<script>
  ...
  AccountKit_OnInteractive = function(){
    AccountKit.init(
      {
        appId:{{Setting::get('fb_app_id', 444999092585626)}},
        state:"state", 
        version: "{{Setting::get('fb_app_version', 'v2.12')}}",
