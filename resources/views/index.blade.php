...
<div class="row white-section no-margin">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <p>{{ Setting::get('site_title', 'Xeride')  }} is the smartest way to get around. One tap and a car comes directly to you. Your driver knows exactly where to go. And you can pay with either cash or card.</p>
...
<div class="row gray-section no-margin">
    <div class="container">                
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>Daily commute. Errand across town. Early morning flight. Late night drinks. Wherever you’re headed, count on {{ Setting::get('site_title', 'Xeride') }} for a ride—no reservations needed.</p>
            <a class="content-more" href="#">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
        <div class="col-md-6 img-block text-center"> 
...
<div class="row white-section no-margin">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>You can always request everyday cars at everyday prices. But sometimes you need a bit more space. Or you want to go big on style. With {{ Setting::get('site_title', 'Xeride') }}, the choice is yours.</p>
            <a class="content-more" href="#">MORE REASONS TO RIDE <i class="fa fa-chevron-right"></i></a>
        </div>
    </div>
</div>
...
<div class="row gray-section no-margin full-section">
    <div class="container">                
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>What makes the {{ Setting::get('site_title', 'Xeride') }} experience truly great are the people behind the wheel. They are mothers and fathers. Students and teachers. Veterans. Neighbors. Friends. Our partners drive their own cars—on their own schedule—in cities big and small. Which is why more than one million people worldwide have signed up to drive.</p>
            <a class="content-more-btn" href="#">WHY DRIVE WITH {{ Setting::get('site_title', 'Xeride')  }} <i class="fa fa-chevron-right"></i></a>
        </div>
...
<div class="row white-section no-margin">
    <div class="container">
        ...
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>A city with {{ Setting::get('site_title', 'Xeride') }} has more economic opportunities for residents, fewer drunk drivers on the streets, and better access to transportation for those without it.</p>
...
<div class="row gray-section no-margin">
    <div class="container">
        <div class="col-md-6 content-block">
            ...
            <div class="title-divider"></div>
            <p>Whether riding in the backseat or driving up front, every part of the {{ Setting::get('site_title', 'Xeride') }} experience has been designed around your safety and security.</p>
...
<div class="row find-city no-margin">
    <div class="container">
        <h2>{{ Setting::get('site_title','Xeride') }} is in USA</h2>
        <form>
