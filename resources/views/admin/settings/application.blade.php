    	...
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{ route('admin.settings.store') }}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="text" value="{{ Setting::get('site_title', 'Xeride')  }}" name="site_title" required id="site_title" placeholder="Site Name">
					</div>
				</div>
				...
				<div class="form-group row">
					<label for="provider_welcome_email" class="col-xs-2 col-form-label">Provider Welcome Email</label>
					<div class="col-xs-10">
						<textarea class="form-control" cols="100" rows="100" value="{{ Setting::get('provider_welcome_email', '') }}" name="provider_welcome_email" required id="provider_welcome_email"></textarea>
					</div>
				</div>
