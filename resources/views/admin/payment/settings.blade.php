                ...
                <form action="{{route('admin.settings.payment.store')}}" method="POST">
                    ...
                    <div class="card card-block card-inverse card-info">
                        <blockquote class="card-blockquote">
                            ...
                            <div class="form-group row">
                                <label for="video_reward" class="col-xs-4 col-form-label">Video Reward</label>
                                <div class="col-xs-8">
                                    <input class="form-control"
                                           type="text"
                                           value="{{ Setting::get('video_reward', '0')  }}"
                                           id="video_reward"
                                           name="video_reward"
                                           placeholder="Video Reward">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-8">
                                    <select name="currency" class="form-control" required>
                                        <option @if(Setting::get('currency') == "GH₵") selected @endif value="$">Ghanaian Cedi (GH₵)</option>
                                        ...
                                        <option @if(Setting::get('currency') == "R") selected @endif value="R"> South African Rand (ZAR)</option>
                                    </select>
                                </div>
                            </div>
                        </blockquote>
