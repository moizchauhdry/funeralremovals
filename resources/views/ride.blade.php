...
@section('content')
            ...
            <div class="col-md-4">
                <div class="banner-form">
                    <div class="row no-margin fields">
                        ...
                        <div class="right">
                            <a href="{{url('login')}}">
                                <h3>Ride with {{Setting::get('site_title','Xeride')}}</h3>
    ...
    <div class="row white-section no-margin">
        <div class="container">
            ...
            <div class="col-md-4 content-block small">
                ...
                <div class="title-divider"></div>
                <p>When you arrive at your destination, either pay with cash or have your card automatically charged. With {{ Setting::get('site_title', 'Xeride') }}, the choice is yours.</p>
            </div>
    ...
    <div class="row find-city no-margin">
        <div class="container">
            <h2>{{Setting::get('site_title','Xeride')}} is in your city</h2>
            <form>
