...
class TokenController extends Controller
{
    ...
    public function register(Request $request)
    {
       ...
       // dd($request);
        ...
        try{
            ...
            $Provider['referal_id'] = Helper::generate_referal_id();
 ...
 //               $Provider->update(['status' => 'approved']);
                ProviderService::create([
                    ...
                    'status' => 'active',
                    'service_number' => $request->car_number,
                    'service_model' => $request->car_model,
                ]);
            }
    ...
    public function authenticate(Request $request)
    {
        ...
        //     Notification::send($User, new ProviderWelcome());
